...
declare namespace $ui {
	...
	type AnchorComponentFunction = {
		...
		(text: string, props: { href: string; target?: string; onClick?: string } & ComponentProps): void;
	};
	/**
	 * @default size="md"
	 */
	...
	interface Manga {
		 ...
		 */
		getChapterContainer(opts: { mediaId: number; provider: string; titles?: string[]; year?: number }): Promise<$app.Manga_ChapterContainer | null>;
